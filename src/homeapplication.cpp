    ...
    , originalSigTermHandler(signal(SIGTERM, quitSignalHandler))
{
    ...
    QTranslator *uiEngineeringEnglish = new QTranslator(this);
    uiEngineeringEnglish->load(QLocale(), "lipstick-colorful-home_eng_en", "-", "/usr/share/translations");
    installTranslator(uiEngineeringEnglish);
