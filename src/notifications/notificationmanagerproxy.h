 ...
 * Command line was: qdbusxml2cpp ../../src/notifications/notificationmanager.xml -p notificationmanagerproxy -c NotificationManagerProxy -i notification.h
 *
...
#ifndef NOTIFICATIONMANAGERPROXY_H_1371813888
#define NOTIFICATIONMANAGERPROXY_H_1371813888
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> clearCalls()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("clearCalls"), argumentList);
    }

    inline QDBusPendingReply<> clearSMSs()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QLatin1String("clearSMSs"), argumentList);
    }

    inline QDBusPendingReply<> notifyCall(const QString &from)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(from);
        return asyncCallWithArgumentList(QLatin1String("notifyCall"), argumentList);
    }

    inline QDBusPendingReply<> notifySMS(const QString &from)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(from);
        return asyncCallWithArgumentList(QLatin1String("notifySMS"), argumentList);
    }
